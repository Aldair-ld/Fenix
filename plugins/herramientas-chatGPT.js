...
let sistema1 = `Actuaras como un Bot de WhatsApp el cual fue creado por GataNina-Li, tu seras FENIX - BOT`;
...
try {
const syms1 = `Actuaras como un Bot de WhatsApp el cual fue creado por GataNina-Li, tu seras FENIX - BOT.`;
